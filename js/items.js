...
items = [{
  ...
  {
    category: "Publications",
    workplace: "<a href='https://towardsdatascience.com/two-important-machine-learning-concepts-to-improve-every-model-62fd058916b'>Two Important Machine Learning Concepts to Improve Every Model</a><p class='subtitle'>How understanding bias and variance can increase your model's accuracy</p>",
    role: "<a href='https://towardsdatascience.com/'><svg viewBox='0 0 45 45' class='mediumIcon' width='25' height='25'><path d='M5 40V5h35v35H5zm8.56-12.627c0 .555-.027.687-.318 1.03l-2.457 2.985v.396h6.974v-.396l-2.456-2.985c-.291-.343-.344-.502-.344-1.03V18.42l6.127 13.364h.714l5.256-13.364v10.644c0 .29 0 .342-.185.528l-1.848 1.796v.396h9.19v-.396l-1.822-1.796c-.184-.186-.21-.238-.21-.528V15.937c0-.291.026-.344.21-.528l1.823-1.797v-.396h-6.471l-4.622 11.542-5.203-11.542h-6.79v.396l2.14 2.64c.239.292.291.37.291.768v10.353z'></path></svg></a><span class='towardsdatascience'>Towards Data Science — Machine Learning</span>",
    date: "April 2020",
    objectives: [],
    indexShow: false,
  ...
  {
    category: "Other Projects",
    workplace: "<a href='https://github.com/mm909/PCA-MNIST'>Principal Component Analysis on MNIST</a> — <a href='http://yann.lecun.com/exdb/mnist/'>MNIST</a>",
  ...
  {
    category: "Other Projects",
    workplace: "<a href='https://github.com/mm909/PCA-MNIST'>Principal Component Analysis in C++</a> — <a href='http://www.cs.otago.ac.nz/cosc453/student_tutorials/principal_components.pdf'>PCA</a>",
    role: "Implemented PCA from scratch using SVD.",
    date: "Spring 2020",
    objectives: [
      "Implemented PCA from scratch in C++ using a toy dataset.",
      "Computed Eigen vectors and values using the Eigen libary.",
      "Restored original data after reducing dimensions to see the amount of variance preserved."
    ],
    index: [
      'ML',
